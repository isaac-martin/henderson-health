    ...
    <div id="wrap-header" class="wrap-header">
      <header id="masthead" class="site-header">
        <a class="home-logo" href="<?php echo get_bloginfo('url'); ?>">
          <svg class="full-logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 191 35.89"><defs>
          ...
          <svg class="logo-icon" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          	 viewBox="0 0 31.3 35.9" style="enable-background:new 0 0 31.3 35.9;" xml:space="preserve">
          <style type="text/css">
          ...
          <g id="Layer_2">
          	<g id="Layer_1-2">
          			...
          			<linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="26.045" y1="18.38" x2="26.045" y2="7.01" gradientTransform="matrix(1 0 0 -1 0 38)">
          			<stop  offset="0" style="stop-color:#00B6F0"/>
          			<stop  offset="0.38" style="stop-color:#2FD5F7"/>
          			<stop  offset="0.83" style="stop-color:#62F6FF"/>
          		</linearGradient>
          		<path class="st0" d="M27.8,17v3.5h-3.6V17h-3.3c0,9.1,0,18.5-0.1,18.6h10.5V17H27.8z"/>

          			<linearGradient id="SVGID_2_" gradientUnits="userSpaceOnUse" x1="26.05" y1="35.31" x2="26.05" y2="5.94" gradientTransform="matrix(1 0 0 -1 0 38)">
          			<stop  offset="0" style="stop-color:#00B6F0"/>
          			<stop  offset="0.38" style="stop-color:#2FD5F7"/>
          			<stop  offset="0.83" style="stop-color:#62F6FF"/>
          		</linearGradient>
          		<path class="st1" d="M24.2,13.4V9.9h3.6v3.6h3.5V0.1H20.8c0,0,0,6.2,0.1,13.3H24.2z"/>
          		<path class="st2" d="M27.8,17v3.5h-3.6V17h-3.5v-3.6h3.5v-1C23,12.1,21.7,12,20.4,12c-3.8-0.1-7.5,1.5-9.9,4.4V0.1H0v35.5h10.5
          			V23.3c1.1-1.3,2.5-2.9,5.3-2.9c3,0,5,1.2,5,4.9v10.4h10.5V21.4c0-1.5-0.3-3-1-4.3L27.8,17z"/>
          	</g>
          </g>
          </svg>
